    ...
    return (
      <div className="min-h-screen bg-light flex items-center justify-center p-4">
        <div className="w-full max-w-sm text-center">
          ...
          <p className="text-sm text-gray-500 mb-6">We sent a confirmation link to <strong className="text-gray-900">{email}</strong>. Click the link to activate your account.</p>
    ...
    <div className="min-h-screen bg-light flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8">
          ...
          <p className="text-sm text-gray-500 mb-6">Start your free 30-day trial. No credit card required.</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full bg-gray-50 border border-gray-200 rounded-lg pl-10 pr-10 py-2.5 text-sm text-gray-900 placeholder-gray-500 focus:outline-none focus:border-primary/60 focus:ring-1 focus:ring-primary/30 transition-all"
                />
