        ...
        <div className="bg-dark2 rounded-2xl border border-white/10 p-8">
          {sent ? (
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400 mb-6">Check your inbox for a link to reset your password.</p>
            ...
            <>
              ...
              <div className="mt-6 text-center">
                <Link to="/login" className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-1 justify-center">
                  <ArrowLeft className="w-4 h-4" /> Back to sign in
                </Link>
              </div>
            </>
