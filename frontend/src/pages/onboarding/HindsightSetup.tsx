    ...
    <div className="fade-in">
      <div className="mb-8">
        ...
        <div className="flex items-center gap-2 mb-2">
          <h1 className="text-2xl font-bold text-gray-900">Enable Hindsight™</h1>
          <span className="px-2 py-0.5 rounded-full bg-primary/20 text-primary text-xs font-semibold">AI Feature</span>
        </div>
        <p className="text-gray-500">Hindsight™ is ExceptionOS's institutional memory engine. It learns from every decision your organization makes.</p>
      </div>
      ...
      <div className="bg-primary/5 border border-primary/20 rounded-xl p-5 mb-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-sm font-semibold text-gray-900">What Hindsight™ does</span>
        </div>
      ...
      {/* Toggle */}
      <div className="flex items-center justify-between p-4 bg-gray-50 border border-gray-200 rounded-xl mb-8">
        <div>
          <div className="text-sm font-medium text-gray-900">Enable Hindsight™ Memory Engine</div>
