  ...
  return (
    <div className="fade-in space-y-6">
      ...
      <div className="bg-green-500/5 border border-green-500/30 rounded-xl p-6 flex items-center gap-4">
        ...
        <div>
          <div className="text-xs text-green-400 font-semibold mb-1 uppercase tracking-wide">Exception Approved</div>
          <div className="text-xl font-bold text-white mb-1">Approved with Conditions</div>
      ...
      <div className="bg-dark2 rounded-xl border border-white/10 p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-semibold text-white">Conditions Tracking</h3>
        </div>
