    ...
    <div className="fade-in space-y-6">
      ...
      <div className="bg-green-500/5 border border-green-500/30 rounded-xl p-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            <div className="text-xs font-semibold text-green-700 mb-1 uppercase tracking-wide">AI Recommendation</div>
            <div className="text-xl font-bold text-gray-900 mb-2">Approve with Conditions</div>
            ...
            <div className="flex items-center gap-2 mt-3">
              ...
              <div className="flex items-center gap-1">
                {[...Array(5)].map((_, i) => (
                  <div key={i} className={`w-2 h-5 rounded-sm ${i < 4 ? 'bg-green-500' : 'bg-gray-100'}`} />
                ))}
              </div>
              <span className="text-sm text-green-700 font-medium">82%</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-semibold text-gray-900">Required Conditions for Approval</h3>
        </div>
